...
export default function DocsPage() {
  return (
    <div className="flex min-h-screen flex-col section-pad">
      <div className="flex-1 mx-auto w-full max-w-6xl px-6">
        ...
        <GlassCard>
          <div className="mb-6 flex flex-wrap gap-2">
            {sections.map((section, idx) => (
              <button
                key={section}
                className={`rounded-full px-4 py-2 text-xs transition ${idx === 0
